...
division_variable = int(division_variable)
print(division_variable)
print(type(division_variable))
...
print(type(multiplication_variable))
...
space = " "
# Prints: ?
joined_vars = variable_four + space + variable_five
print(joined_vars)
...
will_not_work = "My favorite number is " + str(my_fav_number)
print(will_not_work)
